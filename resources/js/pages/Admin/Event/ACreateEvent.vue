            ...
            <div class="p-8">
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            <Label for="seat_limit" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Seat Limit</Label>
                            <Input type="number" id="seat_limit" v-model="form.seat_limit" min="0" class="border border-gray-300" placeholder="0 = unlimited"/>
                            <span v-if="form.errors.seat_limit" class="mt-1 text-xs text-red-500">{{ form.errors.seat_limit }}</span>
                        </div>
                    </div>
