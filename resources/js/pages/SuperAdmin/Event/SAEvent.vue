...
const editForm = useForm({ id: null, title: '', description: '', start_date: '', end_date: '', start_time: '', end_time: '', location: '', seat_limit: 0, image: null, layoutImage: null });

function openEditDialog(event) {
    Object.assign(editForm, {
        id: event.eventID, title: event.title, description: event.description,
        start_date: event.start_date, end_date: event.end_date, start_time: event.start_time, end_time: event.end_time, location: event.location,
