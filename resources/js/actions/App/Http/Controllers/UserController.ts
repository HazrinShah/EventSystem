...
/**
* @see \App\Http\Controllers\UserController::adminList
 * @see app/Http/Controllers/UserController.php:12
 * @route '/admin-users'
 */
export const adminList = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: adminList.url(options),
    method: 'get',
})

adminList.definition = {
    methods: ["get","head"],
    url: '/admin-users',
 ...
 * @route '/admin-users'
 */
adminList.url = (options?: RouteQueryOptions) => {
    return adminList.definition.url + queryParams(options)
}
 ...
 * @route '/admin-users'
 */
adminList.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: adminList.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin-users'
 */
adminList.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: adminList.url(options),
    method: 'head',
})
 ...
 * @route '/admin-users'
 */
    const adminListForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: adminList.url(options),
        method: 'get',
    })
 ...
 * @route '/admin-users'
 */
        adminListForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: adminList.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin-users'
 */
        adminListForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: adminList.url({
...
const UserController = { adminList, store, update, deactivate, reactivate }
